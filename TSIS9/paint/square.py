...
class Button:  
    def __init__(self):
        self.rect = pygame.draw.rect(SCREEN, WHITE, (WIDTH // 2 - 20, 20, 40, 40))

    def draw(self):
        self.rect = pygame.draw.rect(SCREEN, WHITE, (WIDTH // 2, 20, 40, 40))
...
class Rectangle(GameObject):
    ...
    def draw(self):
        start_pos_x = min(self.start_pos[1], self.end_pos[1])
        start_pos_y = min(self.start_pos[1], self.end_pos[1])

        end_pos_x = max(self.start_pos[1], self.end_pos[1])
